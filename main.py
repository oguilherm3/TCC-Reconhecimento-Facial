...
imgElon = face_recognition.load_image_file('ImageBasic/guilherme.jpeg')
...
faceLoc = face_recognition.face_locations(imgElon)[0] # top_right, bottom_right, top_left, bottom_left
